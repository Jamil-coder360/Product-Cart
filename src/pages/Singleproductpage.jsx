  ...
  <div className="lg:max-w-6xl max-w-xl mx-auto">
    <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-12 max-sm:gap-8">
      <div className="w-full lg:sticky top-0">
        <div className="flex flex-col gap-4">
          <div className="bg-white shadow-sm p-2">
            <img src="https://readymadeui.com/images/sunscreen-img-1.webp" alt="Product" className="w-full  aspect-[11/8] object-cover object-top" />
          </div>
          <div className="bg-white shadow-sm p-2 w-full max-w-full overflow-auto">
            <div className="flex justify-between flex-row gap-4 shrink-0">
              <img src="https://readymadeui.com/images/sunscreen-img-1.webp" alt="Product1" className="w-16 h-16 aspect-square object-cover object-top cursor-pointer shadow-md border-b-2 border-black" />
              <img src="https://readymadeui.com/images/sunscreen-img-2.webp" alt="Product2" className="w-16 h-16 aspect-square object-cover object-top cursor-pointer shadow-md border-b-2 border-transparent" />
              <img src="https://readymadeui.com/images/sunscreen-img-3.webp" alt="Product3" className="w-16 h-16 aspect-square object-cover object-top cursor-pointer shadow-md border-b-2 border-transparent" />
              <img src="https://readymadeui.com/images/sunscreen-img-4.webp" alt="Product4" className="w-16 h-16 aspect-square object-cover object-top cursor-pointer shadow-md border-b-2 border-transparent" />
              <img src="https://readymadeui.com/images/sunscreen-img-5.webp" alt="Product5" className="w-16 h-16 aspect-square object-cover object-top cursor-pointer shadow-md border-b-2 border-transparent" />
              <img src="https://readymadeui.com/images/sunscreen-img-6.webp" alt="Product6" className="w-16 h-16 aspect-square object-cover object-top cursor-pointer shadow-md border-b-2 border-transparent" />
            </div>
          </div>
        </div>
      </div>
      <div className="w-full">
        <div>
          <h3 className="text-lg sm:text-xl font-semibold text-slate-900">SunProtect Sunscreen SPF</h3>
          <div className="flex items-center gap-3 mt-2">
            <div className="flex items-center gap-1">
              <p className="text-base text-slate-500">4</p>
              <svg className="w-3.5 h-3.5 fill-purple-600" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="mt-4">
            <p className="text-slate-500 mt-1 text-sm">Contains Vitamin E and Green Tea Extract to protect, nourish, and
              hydrate the skin while providing antioxidant benefits to combat free radicals and promote a healthy
              complexion.</p>
          </div>
          <div className="flex items-center flex-wrap gap-2 mt-6">
            <p className="text-slate-500 text-base"><strike>$16</strike></p>
            <h4 className="text-purple-800 text-2xl sm:text-3xl font-semibold">$12</h4>
        ...
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-4">
            <button type="button" className="px-4 py-3 w-[45%] cursor-pointer border border-gray-300 bg-white hover:bg-slate-50 text-slate-900 text-sm font-medium">Add
              to cart</button>
            <button type="button" className="px-4 py-3 w-[45%] cursor-pointer border border-purple-600 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium">Buy
              it now</button>
          </div>
        </div>
        <hr className="my-6 border-gray-300" />
        <div>
          ...
          <div className="flex items-center gap-2 mt-6 max-w-sm">
            <input type="number" placeholder="Enter pincode" className="bg-white px-4 py-2.5 text-sm w-full  border border-gray-300 outline-0" />
            <button type="button" className="border border-purple-600 outline-0 bg-purple-600 hover:bg-purple-700 text-white cursor-pointer px-4 py-2.5 text-sm">Apply</button>
          </div>
        </div>
